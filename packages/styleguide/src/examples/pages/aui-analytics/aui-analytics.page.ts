...
@Component({
  templateUrl: './aui-analytics.page.html',
})
export class AnalyticsDemoPageComponent {
  public javascript1 = `import { AnalyticsModule } from '@acpaas-ui/ngx-analytics';
...
export class AppModule {};`;
  ...
  public javascript3 = `import { GaService } from '@acpaas-ui/ngx-analytics';
