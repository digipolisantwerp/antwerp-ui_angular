...
@Component({
  templateUrl: './aui-pagination.page.html',
})
export class PaginationDemoPageComponent implements OnInit {
  ...
  public javascript1 = `import { PaginationModule } from '@acpaas-ui/ngx-pagination';
...
private selectHeroes() {
  ...
  public javascript3 = `import { ItemCounterModule } from '@acpaas-ui/ngx-pagination';
