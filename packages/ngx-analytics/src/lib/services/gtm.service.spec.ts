...
describe('The GTM Service', () => {
  ...
  it('should trigger a pageView', inject(
    [GTMService],
  ...
  it('should trigger a pageView with extra variables', inject(
    [GTMService],
    (gtmService: GTMService) => {
      spyOn(gtmService, 'trigger');
      gtmService.triggerPageView({
  ...
  it('should trigger an event', inject(
    [GTMService],
    (gtmService: GTMService) => {
      spyOn(gtmService, 'trigger');
  ...
  it('should trigger an event with label and value', inject(
    [GTMService],
    (gtmService: GTMService) => {
      spyOn(gtmService, 'trigger');
  ...
  it('should trigger any custom trigger', inject(
    [GTMService],
    (gtmService: GTMService) => {
  ...
  it('should trigger any custom trigger with data', inject(
    [GTMService],
    (gtmService: GTMService) => {
      spyOn(gtmService, 'addToDataLayer');
      gtmService.trigger('myCustomTrigger', {
