...
import { DateHelper, DateRange } from '@acpaas-ui/datehelper';
...
import {
    ...
    DatepickerResult
} from '@acpaas-ui/calendar';

import { CalendarService } from '@acpaas-ui/calendar';
...
export class DatepickerComponent implements OnInit, OnDestroy, ControlValueAccessor {
    ...
    public dateMask = { mask: DATE_MASK, 'showMaskOnHover': false };
    ...
    public ngOnInit(): void {
        ...
        this.formControl.valueChanges
            ...
            .subscribe((value) => {
                if (value) {
                    const format = value.split(SEPARATOR_CHAR).reverse().join('-');
    ...
    public validate(ctrl: FormControl): ValidationErrors {
