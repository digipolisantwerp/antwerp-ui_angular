...
export class LeafletComponent implements AfterViewInit, AfterContentInit {
  ...
  @ContentChild(LeafletFullscreenControlComponent, {static: true}) fullScreenControl: LeafletFullscreenControlComponent;
  @ContentChild(LeafletZoomControlComponent, {static: true}) zoomControl: LeafletZoomControlComponent;
  @ContentChild(LeafletLocateControlComponent, {static: true}) locateControl: LeafletLocateControlComponent;
  @ContentChild(LeafletDragControlComponent, {static: true}) dragControl: LeafletDragControlComponent;
  @ContentChild(LeafletDrawControlComponent, {static: true}) drawControl: LeafletDrawControlComponent;
