...
describe('Modal - ModalService', () => {
  ...
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [TestModalComponent, ModalOverlayComponent],
    });

    TestBed.overrideModule(BrowserDynamicTestingModule, {
      set: {
        entryComponents: [TestModalComponent, ModalOverlayComponent],
      },
    });
  }));
  ...
  describe('openModal', () => {
    it(
      'should create a modal instance',
    ...
    it(
      'should set the provided data and actions on the modal instance',
      injectService((modalService: ModalService) => {
  ...
  describe('closeModal', () => {
    ...
    it(
      'should be able to close a modal and its overlay',
      injectService((modalService: ModalService) => {
        modalService.openModal(TestModalComponent);
