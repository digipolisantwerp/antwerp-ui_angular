(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/forms'), require('lodash-es'), require('@acpaas-ui/ngx-components/flyout'), require('@angular/common'), require('@acpaas-ui/ngx-components/selectable-list'), require('rxjs/Subject'), require('rxjs/operators'), require('@acpaas-ui/js-date-utils'), require('@acpaas-ui/ngx-components/calendar'), require('@acpaas-ui/ngx-components/utils'), require('rxjs/operators/takeUntil'), require('rxjs/Observable'), require('@angular/platform-browser'), require('@acpaas-ui/ngx-components/progress-bar'), require('ng2-ckeditor')) :
    typeof define === 'function' && define.amd ? define('forms', ['exports', '@angular/core', '@angular/forms', 'lodash-es', '@acpaas-ui/ngx-components/flyout', '@angular/common', '@acpaas-ui/ngx-components/selectable-list', 'rxjs/Subject', 'rxjs/operators', '@acpaas-ui/js-date-utils', '@acpaas-ui/ngx-components/calendar', '@acpaas-ui/ngx-components/utils', 'rxjs/operators/takeUntil', 'rxjs/Observable', '@angular/platform-browser', '@acpaas-ui/ngx-components/progress-bar', 'ng2-ckeditor'], factory) :
    (factory((global.forms = {}),global.ng.core,global.ng.forms,null,null,global.ng.common,null,global.rxjs.Subject,global.rxjs.operators,null,null,null,global.rxjs['operators/takeUntil'],global.rxjs.Observable,global.ng.platformBrowser,null,null));
}(this, (function (exports,core,forms,lodashEs,flyout,common,selectableList,Subject,operators,jsDateUtils,calendar,utils,takeUntil,Observable,platformBrowser,progressBar,ng2Ckeditor) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var AutoCompleteComponent = (function () {
         ...
         */
            function (changes) {
                ...
                var /** @type {?} */ newData = lodashEs.get(changes, 'data.currentValue', []);
        ...
        AutoCompleteComponent.propDecorators = {
            ...
            flyout: [{ type: core.ViewChild, args: [flyout.FlyoutDirective,] }],
            flyoutZone: [{ type: core.ViewChild, args: [flyout.FlyoutZoneDirective,] }],
        ...
        AutoCompleteModule.decorators = [
            { type: core.NgModule, args: [{
                        imports: [
                            ...
                            forms.FormsModule,
                            flyout.FlyoutModule,
                            selectableList.SelectableListModule,
                            MaskModule,
                        ],
     ...
     * @suppress {checkTypes} checked by tsc
     */
    var /** @type {?} */ DATEPICKER_ERROR_LABELS = new core.InjectionToken('errorLabels');
    ...
    var DatepickerComponent = (function () {
        function DatepickerComponent(monthLabels, weekdayLabels, errorLabels, calendarService, formBuilder) {
            if (monthLabels === void 0) {
                monthLabels = calendar.CALENDAR_DEFAULT_MONTH_LABELS;
            }
            if (weekdayLabels === void 0) {
                weekdayLabels = calendar.CALENDAR_DEFAULT_WEEKDAY_LABELS;
            }
            if (errorLabels === void 0) {
            ...
            function () {
                ...
                this.formControl.valueChanges
                    ...
                    if (value) {
                        ...
                        var /** @type {?} */ date = jsDateUtils.DateHelper.parseDate(format);
                        if (date) {
         ...
         */
            function (value) {
                var /** @type {?} */ date = jsDateUtils.DateHelper.parseDate(value);
         ...
         */
            function (ctrl) {
                ...
                if (!jsDateUtils.DateHelper.parseDate(ctrl.value)) {
                    return {
        ...
        DatepickerComponent.ctorParameters = function () {
            return [
                { type: undefined, decorators: [{ type: core.Inject, args: [calendar.CALENDAR_MONTH_LABELS,] }] },
                { type: undefined, decorators: [{ type: core.Inject, args: [calendar.CALENDAR_WEEKDAY_LABELS,] }] },
     ...
     * @suppress {checkTypes} checked by tsc
     */
    var ɵ0 = calendar.CALENDAR_DEFAULT_WEEKDAY_LABELS, ɵ1 = calendar.CALENDAR_DEFAULT_MONTH_LABELS, ɵ2 = DATEPICKER_DEFAULT_ERROR_LABELS;
    var DatepickerModule = (function () {
         ...
         */
            function (weekdayLabels, monthLabels, errorLabels) {
                return {
                    ...
                    providers: [
                        { provide: calendar.CALENDAR_WEEKDAY_LABELS, useValue: weekdayLabels },
                        { provide: calendar.CALENDAR_MONTH_LABELS, useValue: monthLabels },
        ...
        DatepickerModule.decorators = [
            { type: core.NgModule, args: [{
                        ...
                        providers: [
                            { provide: calendar.CALENDAR_WEEKDAY_LABELS, useValue: ɵ0 },
                            { provide: calendar.CALENDAR_MONTH_LABELS, useValue: ɵ1 },
    ...
    var FieldErrorsComponent = (function () {
        ...
        FieldErrorsComponent.propDecorators = {
            ...
            errorDefinition: [{ type: core.Input }]
        };
     ...
     * @suppress {checkTypes} checked by tsc
     */
    var FieldErrorsModule = (function () {
    ...
    var RangeSliderComponent = (function () {
         ...
         */
            function (event) {
                ...
                var /** @type {?} */ x = ((event)).x !== undefined ? ((event)).x : ((event)).targetTouches[0].pageX;
        ...
        RangeSliderComponent.decorators = [
            { type: core.Component, args: [{
                        ...
                        providers: [
                            {
                                provide: forms.NG_VALUE_ACCESSOR,
                                useExisting: core.forwardRef(function () { return RangeSliderComponent; }),
                                // tslint:disable-line
                                multi: true,
                            },
                        ],
        ...
        RangeSliderComponent.propDecorators = {
            core_branding: [{ type: core.HostBinding, args: ['class.m-range-slider',] }],
            min: [{ type: core.Input }],
            max: [{ type: core.Input }],
     ...
     * @suppress {checkTypes} checked by tsc
     */
    var RangeSliderModule = (function () {
    ...
    var SearchFilterComponent = (function () {
        function SearchFilterComponent() {
            this.flyoutSize = flyout.FlyoutSize.Small;
            this.label = 'Filter';
         ...
         */
            function (changes) {
                var /** @type {?} */ choices = lodashEs.get(changes, 'choices.currentValue', null);
                if (!choices) {
                    return;
                }
                if (this.remote) {
        ...
        SearchFilterComponent.decorators = [
            { type: core.Component, args: [{
                        ...
                        providers: [{
                                provide: forms.NG_VALUE_ACCESSOR,
                                useExisting: core.forwardRef(function () { return SearchFilterComponent; }),
                                // tslint:disable-line:no-forward-ref
                                multi: true,
                            }],
                    },] },
     ...
     * @suppress {checkTypes} checked by tsc
     */
    var TimePickerValidators = (function () {
         ...
         */
            function () {
                ...
                this.fallbackForm.valueChanges
                    .pipe(takeUntil.takeUntil(this.componentDestroyed$))
    ...
    var /** @type {?} */ UPLOAD_VALIDATION_MESSAGES = new core.InjectionToken('uploadValidationMessages');
     ...
     * @suppress {checkTypes} checked by tsc
     */
    var UploadInputComponent = (function () {
     ...
     * @suppress {checkTypes} checked by tsc
     */
    var UploadZoneComponent = (function () {
     ...
     * @suppress {checkTypes} checked by tsc
     */
    var UploadedListComponent = (function () {
    ...
    var ValidationMessagesService = (function () {
        ...
        /** @nocollapse */
        ValidationMessagesService.ctorParameters = function () {
            return [
     ...
     * @suppress {checkTypes} checked by tsc
     */
    var ValidationListComponent = (function () {
         ...
         */
            function (reasons) {
                ...
                try {
                    ...
                    try {
                        if (reasons_1_1 && !reasons_1_1.done && (_a = reasons_1.return))
                            _a.call(reasons_1);
                    }
                    finally {
                        if (e_1)
        ...
        /** @nocollapse */
        ValidationListComponent.ctorParameters = function () {
            return [
    ...
    var WysiwygComponent = (function () {
        ...
        WysiwygComponent.decorators = [
            { type: core.Component, args: [{
                        ...
                        providers: [{
                                provide: forms.NG_VALUE_ACCESSOR,
                                useExisting: core.forwardRef(function () { return WysiwygComponent; }),
                                // tslint:disable-line:no-forward-ref
                                multi: true,
                            }],
                    },] },
    ...
    exports.FieldErrorsModule = FieldErrorsModule;
    ...
    exports.UploadedListComponent = UploadedListComponent;
