 ...
 * @suppress {checkTypes} checked by tsc
 */
const /** @type {?} */ LOAD_DATA = 'Loading data...';
const /** @type {?} */ NO_DATA = 'No data available.';
const /** @type {?} */ NO_COLUMNS = 'No columns available.';
